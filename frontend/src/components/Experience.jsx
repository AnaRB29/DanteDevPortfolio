...
const iconMap = { briefcase: Briefcase, wrench: Wrench, code: Code, graduation: GraduationCap };
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="pixel-font text-[10px] text-[#D54527]">{t.experience.chapter}</span>
          </div>
        ...
        <div className="relative">
          <div className="absolute left-6 md:left-1/2 top-2 bottom-2 w-[3px] -ml-[1.5px]"
            style={{
                ...
                <div key={exp.id} className="relative md:grid md:grid-cols-2 md:gap-10">
                  ...
                  <div className={`pl-20 md:pl-0 ${isLeft ? "md:pr-12 md:text-right" : "md:col-start-2 md:pl-12"}`}>
                    <div className="bg-[#FBF6E9] text-[#271914] border-[4px] border-[#FBF6E9] p-5 pixel-shadow inline-block w-full">
                      <div className="retro-font text-[16px] text-[#B68669] mb-1">{pick(exp.period, lang)}</div>
                      <h3 className="pixel-font text-[12px] text-[#271914] leading-snug mb-2">{pick(exp.role, lang)}</h3>
                      ...
                      <p className="body-font text-[14px] text-[#1F2937]/90 leading-relaxed">{pick(exp.description, lang)}</p>
                    </div>
                  </div>
                </div>
              );
